...
public class Student_V2 {
	...
	public Student_V2(String studentName, int studentNumber) {
		...
		StudentClass Class1 = new StudentClass("UNENROLLED");
		StudentClass Class2 = new StudentClass("UNENROLLED");
		StudentClass Class3 = new StudentClass("UNENROLLED");
		StudentClass Class4 = new StudentClass("UNENROLLED");
		StudentClass Class5 = new StudentClass("UNENROLLED");
		StudentClass Class6 = new StudentClass("UNENROLLED");
		StudentClass Class7 = new StudentClass("UNENROLLED");
	...
	//	 setters
	public void setClassName(int periodNumber, String newClassName) {
		classObjectInformation[periodNumber - 1].setClassName(newClassName);
	}
